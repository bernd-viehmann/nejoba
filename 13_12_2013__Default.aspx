<%@ Page Title="nejoba - Ort festlegen" Language="IronPython" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="13_12_2013__Default.aspx.py" %>
                ...
                <div id ="location_choose" >
                    <div class="">
                        ...
                        <div class="span6">
                            ...
                            <div class="row">
                                <h5><asp:Label ID="Label3" runat="server" Text="Job-Börse"></asp:Label></h5>
                                <div class="span4">
                                    <asp:LinkButton ID="hyLnk_openJobs" runat="server" class="btn btn-large btn-success" style="width:100%;" data-toggle="tooltip" title="Börse für Nachbarschaftshilfe" OnClick="HandlBtnClick" OnClientClick="return checkForCountry();"><i class="icon-briefcase icon-black"></i> Arbeit suchen</asp:LinkButton>
                                </div>
                            ...
                            <div class="row">
                                <h5><asp:Label ID="LabelNbFrm" runat="server" Text="Nachbarforum"></asp:Label></h5>
                                <div class="span4">
                                    
                                    <asp:LinkButton ID="hyLnk_openList" runat="server" class="btn btn-large btn-success" style="width:100%;" data-toggle="tooltip" title="Die Beiträge im Forum als Liste" OnClick="HandlBtnClick" OnClientClick="return checkForCountry();"><i class="icon-th-list icon-black"></i> als Liste </asp:LinkButton>
                                </div>
                                <div class="span4 offset1">
                                    
                                    <asp:LinkButton ID="hyLnk_openMap" runat="server" class="btn btn-large btn-success" style="width:100%;" data-toggle="tooltip" title="Veranstaltungen und markierte Orte auf der Karte anzeigen" OnClick="HandlBtnClick" OnClientClick="return checkForCountry();"><i class="icon-map-marker icon-black"></i> als Karte</asp:LinkButton>
                                </div>
                            </div>
                            <br /><br />
