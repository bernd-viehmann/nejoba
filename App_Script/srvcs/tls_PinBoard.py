# ***********************************************************************************************************************************************
# tls_PinBoard.py : class for the defalt PinBoard-webform. Select a location 
#
...
class PinBoard( mongoDbMgr.mongoMgr ):
    # ***********************************************************************************************************************************************
...
# --  ---  ---  ---  ---  ---  ---  ---  ---  ---  ---  ---  ---  ---  ---  ---  ---  ---  ---  ---  ---  ---  ---  ---  ---  ---  ---  ---  ---  ---  ---  ---  ---  ---  ---  ---  ---  ---  ---  ---  ---  ---  ---  ---  ---  ---  ---  ---  ---  -
    ...
    def HndlrStartSearch(self, sender, e):
        try:
            ...
            # urlNext = WebConfigurationManager.AppSettings['simplePinnBoard'] + '?loc=' + locStrng
            urlNext = WebConfigurationManager.AppSettings['debateProjector'] + '?Loc=' + locStrng
