                ...
                <div id ="location_choose" >
                    <div class="">
                        ...
                        <div class="span6">
                            ...
                            <div class="row">
                                <div class="span5">
                                    <asp:LinkButton ID="hyLnk_openJobs" runat="server" class="btn btn-large btn-success" style="width:100%;" data-toggle="tooltip" title="Börse für Nachbarschaftshilfe" OnClick="HandlBtnClick" OnClientClick="return checkForCountry();"><i class="icon-briefcase icon-black"></i> Job-Börse</asp:LinkButton>
                                    <br />
                                    <h5><asp:Label ID="Label2" runat="server" Text="Der regionale Arbeitsmarkt"></asp:Label></h5>
                                </div>
                                <div class="span5 offset1">
                                    <asp:LinkButton ID="hyLnk_openBlog" runat="server" class="btn btn-large btn-success" style="width:100%;" data-toggle="tooltip" title="Regionaler Micro-Blog vernetzt die Nachbarschaft" OnClick="HandlBtnClick" OnClientClick="return checkForCountry();"><i class="icon-map-marker icon-black"></i> Nachbarforum</asp:LinkButton>
                                    <br />
