...
$(document).ready(function () {
    ...
    // UI stuff  UI stuff  UI stuff  UI stuff  UI stuff  UI stuff  UI stuff  UI stuff  UI stuff  UI stuff  UI stuff  UI stuff  UI stuff  UI stuff  UI stuff  UI stuff  
    // UI stuff  UI stuff  UI stuff  UI stuff  UI stuff  UI stuff  UI stuff  UI stuff  UI stuff  UI stuff  UI stuff  UI stuff  UI stuff  UI stuff  UI stuff  UI stuff  
    // UI stuff  UI stuff  UI stuff  UI stuff  UI stuff  UI stuff  UI stuff  UI stuff  UI stuff  UI stuff  UI stuff  UI stuff  UI stuff  UI stuff  UI stuff  UI stuff  

//    initOsmMap();                 // init the OSM map. 
    mgr = new MtrxMngr();   // init the rubric-selection-part
    ...
    // click function for startsearch : initiate the searching process via ajax
