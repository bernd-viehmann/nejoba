...
class ConfirmMapUser(mongoDbMgr.mongoMgr):
    ...
    # ***********************************************************************************************************************************************
    # UpdateMapUserCache : after a new user was created update the cached data
    #
    # 22.05.2013    berndv  initial realease
    # ***********************************************************************************************************************************************
    def UpdateMapUserCache(self):
        try:
            self.mapUser.addUserFromSession( tool.usrDt.userDict )
    ...
    def LogInAndStart( self ):
        try:
            ...
            url = WebConfigurationManager.AppSettings['mainMapLink']
