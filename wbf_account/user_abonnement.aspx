<%@ Page Title="Diskussionen" Language="IronPython" MasterPageFile="../MasterPage.master" AutoEventWireup="true" CodeFile="user_abonnement.aspx.py" %>
...
<div class="container span10">
                ...
                <div class="accordion-group">
                    <div class="accordion-heading">
                        <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseHeader" >
                            <h4>Deine Abonnements im Nachbarforum</h4>
                        </a>
                    </div>
                    <div id="collapseHeader" class="accordion-body collapse">
                        <div class="accordion-inner">
                            <h5>
                                <asp:Label ID="Label2" runat="server" Text="Liste der Beiträge die du abonniert hast"></asp:Label>
                            </h5>
    ...
    <div id="repeaterOutDiv" class="span12" runat="server" visible="true">
        <asp:Repeater ID="repAboList" runat="server">
            <ItemTemplate>
                <div>
                    <h5>
                        ...
                        <asp:HyperLink ID="hyLnk_opnJob" runat="server" class="spacedTop" Text='<%# Eval("subject")%>' NavigateUrl='<%# Eval("tagZero")%>' />
                    </h5>
                    <small>
