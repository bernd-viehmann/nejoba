<%@ Page Title="Diskussionen" Language="IronPython" MasterPageFile="../MasterPage.master" AutoEventWireup="true" CodeFile="user_debates_adds.aspx.py" %>
...
<div class="container">
            ...
            <div class="accordion-group">
                <div class="accordion-heading">
                    <h4>
                        <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseHeader" >
                            Diskussionen im Nachbarforum an denen du teilnimmst
                        </a>
                    </h4>
                </div>
                <div id="collapseHeader" class="accordion-body collapse">
                    <div class="accordion-inner">
                        <h5>
                            <asp:Label ID="Label2" runat="server" Text="Diskussionen mit deiner Beteiligung."></asp:Label>
                        </h5>
    ...
    <div id="repeaterOutDiv" class="span10" runat="server" visible="true">
        <asp:Repeater ID="repUsrDbtsLst" runat="server">
            <ItemTemplate>
                <div>
                    <h5>
                        <asp:LinkButton ID="btn_OpenDebate" runat="server" ToolTip="Beitrag aufrufen" OnClick="HndlrReactionClick"><%# Eval("subject")%></asp:LinkButton>
                    </h5>
                    <small>
