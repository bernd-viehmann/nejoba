<%@ Page Title="" Language="IronPython" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="debate_editor_simpler.aspx.py" validateRequest="false" EnableEventValidation="false"%>
        ...
        <div class="accordion" id="accordion2">
            ...
            <div class="accordion-group">
                ...
                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseLocation">
                    <h4><asp:Label ID="Label10" runat="server" Text="Ort" ToolTip="Bestimme den Ort und markiere eine Stelle." /></h4>
                </a>
                </div>
            ...
            <div class="accordion-group">
                ...
                <div id="collapseUpload" class="accordion-body collapse">
                    <div class="accordion-inner">
                        <div id="Div2" class="span12"><br /></div>

                        <div id="loadfile" class="span12">
                            <asp:FileUpload ID="FileUpload1" runat="server" />
                        </div>

                        <div id="Div5" class="span12"><br /></div>
                    </div>
                </div>
            </div>
