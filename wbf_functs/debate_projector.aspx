<%@ Page Title="Das nejoba Nachbarforum " Language="IronPython" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="debate_projector.aspx.py" %>
...
<asp:Content ID="ContentBottom" ContentPlaceHolderID="CoPlaBottom" Runat="Server">
        ...
        <div class="span12">
                ...
                <h3>
                    <div class="btn-toolbar pull-left">
                        <div class="btn-group">
                            ...
                            <a id="open_modal"          class="btn" href="#srchDialg" role="button" data-toggle="modal" title="" data-placement="bottom" data-original-title="Suchen"><i class="icon-search"></i></a>
                            ...
                            <a id="open_map"            class="btn" title="" data-placement="bottom" data-toggle="tooltip" data-original-title="Zur Kartenansicht"><i class="icon-globe"></i></a>
                    ...
                    <div class="pull-right">
                        <asp:Label ID="Label1" runat="server" Text="Das Nachbarforum"></asp:Label>
                    </div>
                <hr /><br />
                </h3>
            </div>
            ...
            <div id="ruricon" class="row span12" style="display:none;">
                ...
                <div class="span2 offset1">
                    ...
                    <asp:Label ID="Label3" runat="server" Text="Initiativen" ToolTip="B&uuml;rger- oder gesellschaftliche Initiativen"/>
                    <br />
                    ...
                    <asp:Label ID="Label18" runat="server" Text="Termine" ToolTip="Zum Beispiel Events, Konzerte oder andere Veranstaltungen" />
                    <br />
                </div>
                <div class="span2 offset1">
                ...
                <div class="span2 offset1">
                    ...
                    <asp:Label ID="Labool19" runat="server" Text="Anzeigen" ToolTip="Kaufen, verkaufen, Kontaktbörse oder allgemeine Anfragen"/>
                    <br />
                </div>
                ...
                <div class="span11 offset1"><br />
                    <input id="btn_select_rubrik" class="btn btn-primary" type="button" value="Auswählen" />
                </div>
            </div>
    ...
    <!-- @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@ -->
    <!-- @@                                                                                                                                     @@ -->
    <!-- @@   canvasforlist is the area where the items are displayed
    <!-- @@                                                                                                                                     @@ -->
    <!-- @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@ -->
    <div id="canvasforlist"></div>
    ...
    <!-- @@                                                                                                                                     @@ -->
    <!-- @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@   @@ -->
    <div id="srchDialg" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="srchDialgLabel" aria-hidden="true" style="display:none;">
    ...
    <div id="linkreuse" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="linkreuseLabel" aria-hidden="true">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            <h3 id="linkreuseLabel">Link zur Wiederverwendung</h3>
        </div>
        <div class="modal-body">
            ...
            <br />
            <div>
                <a id="extLinkDisplay"></a>

            </div>
            <br />
            <br />
            <p>Am einfachsten klickst Du auf die rechte Maustaste und setzt so ein Lesezeichen mit der Funktion 'Lesezeichen hinzufügen'. Wenn du die Ansicht in sozialen Netzwerken wie facebook verwenden willst nutze die Funktion 'Linkadresse kopieren' und drücke im Eingabefeld von z.B. facebook 'STRG + v'</p>
        </div>
        <div class="modal-footer">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#open_map').click(function () {                          // open a new tab with the map
                lstExtr.getUrlParams();
                var param = lstExtr.prepareUrl();
                // alert(param);
                var url = '../wbf_activemap/map_two.aspx' + param;
                var win = window.open(url, '_blank');
                win.focus();
            });

            $('#show_bookmark').click(function () {                     // show the link to th
                var pathname = window.location.pathname;
                lstExtr.getUrlParams();
                pathname += lstExtr.prepareUrl();
                // alert(pathname);
                $('#extLinkDisplay').prop('href', pathname).prop('target', '_blank').text(pathname);
            });
            var pathname = window.location.pathname;
