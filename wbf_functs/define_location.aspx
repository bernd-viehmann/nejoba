<%@ Page Title="Suche Diskussionen" Language="IronPython" MasterPageFile="../MasterPage.master" AutoEventWireup="true" CodeFile="define_location.aspx.py" %>
            ...
            <div class="container-fluid">
                <div class="row-fluid">
                    <div class="span3 offset1">
                        <h3><asp:Label ID="Label8" runat="server" Text="Ortsbestimmung" /></h3>
                        <br />
